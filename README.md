...
```mermaid
graph TD
    UserRequest[User Reflection Request] --> Tier1[Tier 1: gemini-3.6-flash]
    Tier1 -->|Success: Sub-second latency| DeliverResponse[Deliver Empathetic Reflection]
    Tier1 -->|Fail: 429 Rate Limit / 503 Overload| Tier2[Tier 2: gemini-3.1-flash-lite]
    Tier2 -->|Success: High-Availability Failover| DeliverResponse
    Tier2 -->|Fail: Network / Service Outage| Tier3[Tier 3: gemini-3.7-flash]
    Tier3 -->|Success: Deep Reasoning Engine| DeliverResponse
    Tier3 -->|Fail: Global API Outage| GracefulFallback[Tier 4: Aura Internal Safe Resilience Protocol]
    GracefulFallback --> DeliverResponse
```
